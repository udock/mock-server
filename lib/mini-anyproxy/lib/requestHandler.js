  ...
  return function (req, userRes) {
    ...
    */
    ...
    fetchReqData()
      ...
      .then(async () => {
        const userModifiedInfo = (await userRule.beforeSendRequest(Object.assign({}, requestDetail))) || {};
      ...
      .then(async (responseData) => {
        if (responseData._directlyPassToRespond) {
          ...
          // TODO: err etimeout
          return (await userRule.beforeSendResponse(Object.assign({}, requestDetail), Object.assign({}, responseData))) || responseData;
        }
      })
  ...
  return function (req, cltSocket, head) {
    ...
    */
    (async () => {
      ...
      shouldIntercept = await userRule.beforeDealHttpsRequest(requestDetail);
